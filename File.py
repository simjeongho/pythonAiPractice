...
#Mode r: read, W : over write, A: Append, R+ : read and write  
#write write():w(Start), a(End)
#writelines(): String list
#Write
#read(n): nbytes
#readline() 한 줄씩 읽어서 문자열로 반환
#readlines() 전체를 읽어서 문자열로 반환
#close
from tkinter import *
def add(x,y):
    result = x+y
...
Button(main, text=">", width=10, command=lambda:get_last_log()).grid(row=0, column=5)
